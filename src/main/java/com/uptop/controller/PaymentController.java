...
import com.uptop.utils.AlipayConfig;
...
* @Description:    用户付款
* @Author:         jiehao
* @CreateDate:     2018/12/6 8:44
* @UpdateUser:     jiehao
* @UpdateDate:     2018/12/6 8:44
* @UpdateRemark:   修改内容
* @Version:        1.0
*/
@Controller
...
public class PaymentController {
    ...
    */
    ...
    public void payment(Order order,HttpServletResponse rep) throws AlipayApiException, IOException {

        out.println(order.getOrderName());
        order.setState("未付款");
        long time=System.currentTimeMillis();
        order.setId((int) time);
        int number=orderService.insertOrder(order);
        out.println(number);
